...
# Now func keyword argument can’t be used for passing filters to the list of filters 
# instead of that you can pass the filters as arguments:
@dp.callback_query_handler(lambda message: message.text == 'button1')
